...
```bash
username="amarkova";
git clone git@github.com:rsm-msba-25-26/rsm-gh-merge-conflict-practice-rsm-amarkova ~/git/rsm-gh-merge-conflict-practice;
```
...
Your name: Alina Markova attempt 2 Date: <insert-the-date-here>
